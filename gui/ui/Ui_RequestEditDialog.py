...
class Ui_RequestDialog(object):
    def setupUi(self, RequestDialog):
        ...
        self.headersPlainTextEdit = QtWidgets.QPlainTextEdit(RequestDialog)
        self.headersPlainTextEdit.setObjectName("headersPlainTextEdit")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.headersPlainTextEdit)
        self.verticalLayout.addLayout(self.formLayout)
        self.reqActivityStatusRadioButton = QtWidgets.QRadioButton(RequestDialog)
        self.reqActivityStatusRadioButton.setObjectName("reqActivityStatusRadioButton")
        self.verticalLayout.addWidget(self.reqActivityStatusRadioButton)
    ...
    def retranslateUi(self, RequestDialog):
        ...
        self.label.setText(_translate("RequestDialog", "Заголовки"))
        self.reqActivityStatusRadioButton.setText(_translate("RequestDialog", "Использовать запрос в тестировании"))
